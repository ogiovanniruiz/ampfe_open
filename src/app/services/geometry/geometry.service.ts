...
export class GeometryService {
  ...
  downloadPolygons(campaignID: number, orgID: string){
    return this.http.post(this.API_URL + '/api/downloadPolygons', {campaignID, orgID});
  }
  ...
  getPrecinctsByBounds(bounds){
    return this.http.post(this.API_URL + '/api/getPrecinctsByBounds', {bounds});
  }
  ...
  editPolygon(polygon: Object){
    return this.http.post(this.API_URL + '/api/editPolygon', polygon);
  }
