...
const routes: Routes = [
  ...
  {path: 'districts', loadChildren: () => import('./components/districts/districts.module').then(m => m.DistrictsModule), canActivate: [AuthGuard]},
  ...
  //{path: 'hotline', loadChildren: () => import('./components/canvass/canvass.module').then(m => m.CanvassModule), canActivate: [AuthGuard]},
