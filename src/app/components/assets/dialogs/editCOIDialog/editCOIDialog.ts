...
@Component({
    templateUrl: './editCOIDialog.html',
  })
  
  export class EditCOIDialog implements OnInit{
    ...
    constructor(
        public dialogRef: MatDialogRef<EditCOIDialog>,
    ...
    deleteCOI(){
      if (confirm('Would you like to delete this target from the database?')) {
        if (!this.shepherdService.isActive) {
          var dialogCloseStatus = {selectedCOI: this.selectedCOI, delete: true}
          this.assetService.deleteCOI(this.selectedCOI._id).subscribe(result => {
