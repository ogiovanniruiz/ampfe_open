...
@Component({
  templateUrl: './editPetitionActivityDialog.html',
  providers: [DatePipe]
})
  
export class EditPetitionActivityDialog implements OnInit{
  ...
  constructor(public dialogRef: MatDialogRef<EditPetitionActivityDialog>,
  ...
  deleteActivity(){
      if(confirm("Are you sure you want to delete this activity?")){
          ...
          this.activityService.deleteActivity(_id, 'Petition').subscribe(
              (result: unknown)=>{
                  this.dialogRef.close(result)
              },
              error =>{
